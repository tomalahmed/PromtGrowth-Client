...
export default function UserStatCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group relative overflow-hidden rounded-2xl border border-outline-variant/15 bg-white p-5 shadow-[0_8px_32px_-8px_rgba(21,82,30,0.1)] transition-shadow hover:shadow-[0_12px_40px_-8px_rgba(21,82,30,0.14)]",
        className
      )}
    >
      {Icon && (
      ...
      <motion.p
        ...
        className="relative text-[28px] font-bold tracking-tight text-primary"
      >
        {value}
      </motion.p>
      {hint && (
