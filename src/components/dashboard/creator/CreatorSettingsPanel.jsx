...
export default function CreatorSettingsPanel() {
  ...
  return (
    <>
      <CreatorPageHeader
        title="Settings"
        subtitle="Manage your creator profile and account preferences."
      />

      <div className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_320px]">
        <CreatorFormCard title="Profile" icon={User}>
        ...
        <div className="space-y-6">
          <CreatorFormCard title="Account" icon={Settings}>
            ...
            <div className="mt-5 flex items-center justify-between rounded-xl border border-outline-variant/15 bg-surface-container-low/50 px-4 py-3">
              <div>
                ...
                <p className="text-[12px] text-on-surface-variant">
                  {profile?.isPremium ? "Lifetime premium access" : "Free creator account"}
                </p>
              </div>
